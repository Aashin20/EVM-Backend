...
def BO_RO_BU(details: List[BUDetail], alloted_to: str, alloted_from: str, order_no:str,filename="Annexure_6.pdf"):
    ...
    # Title
    title = Paragraph("Annexure - VI", title_style)
    ...
    # Main Heading
    heading = Paragraph("Register for distribution of EVM from Block Panchayat Secretary/ERO of Municipality/Corporation to Returning Officer", title_style)
